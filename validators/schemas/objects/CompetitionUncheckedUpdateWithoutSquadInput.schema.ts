...
export const CompetitionUncheckedUpdateWithoutSquadInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Game: GameUncheckedUpdateManyWithoutCompetitionNestedInputObjectSchema
});
