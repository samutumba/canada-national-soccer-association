...
export const NestedDateTimeWithAggregatesFilterObjectSchema = Yup.object({
    equals: Yup.date(),  in: Yup.array().of(Yup.date()),  notIn: Yup.array().of(Yup.date()),  lt: Yup.date(),  lte: Yup.date(),  gt: Yup.date(),  gte: Yup.date(),  not: Yup.mixed().oneOfSchemas([Yup.lazy(() => NestedDateTimeWithAggregatesFilterObjectSchema.default(undefined))]),  _count: NestedIntFilterObjectSchema,  _min: NestedDateTimeFilterObjectSchema,  _max: NestedDateTimeFilterObjectSchema
});
