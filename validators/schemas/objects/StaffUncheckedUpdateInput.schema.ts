...
import { SquadUncheckedUpdateManyWithoutStaffNestedInputObjectSchema } from '../internals';

export const StaffUncheckedUpdateInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  accountId: Yup.mixed().oneOfSchemas([Yup.string(),
NullableStringFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUncheckedUpdateManyWithoutStaffNestedInputObjectSchema
});
