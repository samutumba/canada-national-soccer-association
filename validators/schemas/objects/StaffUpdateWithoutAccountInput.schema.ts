...
export const StaffUpdateWithoutAccountInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUpdateManyWithoutStaffNestedInputObjectSchema
});
