...
export const StaffUpdateWithoutSquadInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  account: AccountUpdateOneWithoutStaffNestedInputObjectSchema
});
