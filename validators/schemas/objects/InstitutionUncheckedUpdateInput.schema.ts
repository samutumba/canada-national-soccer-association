...
import { SquadUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema } from '../internals';

export const InstitutionUncheckedUpdateInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  category: Yup.mixed().oneOfSchemas([EnumInstitutionCategoryFieldUpdateOperationsInputObjectSchema]),  scholarship: ScholarshipUncheckedUpdateManyWithoutSponsorNestedInputObjectSchema,  Squad: SquadUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema
});
