...
export const LocationUncheckedUpdateWithoutSquadInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  game: GameUncheckedUpdateManyWithoutLocationNestedInputObjectSchema
});
