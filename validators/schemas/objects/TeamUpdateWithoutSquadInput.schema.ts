...
export const TeamUpdateWithoutSquadInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Game: GameUpdateOneWithoutTeamNestedInputObjectSchema
});
