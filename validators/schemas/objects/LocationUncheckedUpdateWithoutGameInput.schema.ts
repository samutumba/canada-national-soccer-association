...
export const LocationUncheckedUpdateWithoutGameInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUncheckedUpdateManyWithoutHomeNestedInputObjectSchema
});
