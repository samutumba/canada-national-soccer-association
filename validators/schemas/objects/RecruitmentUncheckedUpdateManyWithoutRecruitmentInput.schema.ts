...
export const RecruitmentUncheckedUpdateManyWithoutRecruitmentInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  accountId: Yup.mixed().oneOfSchemas([Yup.string(),
