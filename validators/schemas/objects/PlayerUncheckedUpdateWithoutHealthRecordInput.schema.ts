...
import { ScholarshipUncheckedUpdateManyWithoutPlayerNestedInputObjectSchema } from '../internals';;
...
export const PlayerUncheckedUpdateWithoutHealthRecordInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  position: Yup.mixed().oneOfSchemas([EnumPostionFieldUpdateOperationsInputObjectSchema]),  phone: Yup.mixed().oneOfSchemas([Yup.string(),
