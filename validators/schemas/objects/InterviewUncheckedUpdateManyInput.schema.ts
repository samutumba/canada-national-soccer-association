...
export const InterviewUncheckedUpdateManyInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  recruitmentId: Yup.mixed().oneOfSchemas([Yup.string(),
