...
export const InstitutionUpdateWithoutScholarshipInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  category: Yup.mixed().oneOfSchemas([EnumInstitutionCategoryFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUpdateManyWithoutInstitutionNestedInputObjectSchema
});
