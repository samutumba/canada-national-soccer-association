...
export const SquadUncheckedUpdateWithoutCompetitionInputObjectSchema = Yup.object({
    id: Yup.mixed().oneOfSchemas([Yup.string(),
StringFieldUpdateOperationsInputObjectSchema]),  name: Yup.mixed().oneOfSchemas([Yup.string(),
StringFieldUpdateOperationsInputObjectSchema]),  players: PlayerUncheckedUpdateManyWithoutSquadNestedInputObjectSchema,  staff: StaffUncheckedUpdateManyWithoutSquadNestedInputObjectSchema,  institutionId: Yup.mixed().oneOfSchemas([Yup.string(),
