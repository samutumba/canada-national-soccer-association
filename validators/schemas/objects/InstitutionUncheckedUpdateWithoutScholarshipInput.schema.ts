...
export const InstitutionUncheckedUpdateWithoutScholarshipInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  category: Yup.mixed().oneOfSchemas([EnumInstitutionCategoryFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema
});
