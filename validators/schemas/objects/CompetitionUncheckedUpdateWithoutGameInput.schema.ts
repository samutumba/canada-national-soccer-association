...
export const CompetitionUncheckedUpdateWithoutGameInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUncheckedUpdateManyWithoutCompetitionNestedInputObjectSchema
});
