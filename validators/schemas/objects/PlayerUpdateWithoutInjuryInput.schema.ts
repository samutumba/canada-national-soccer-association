...
import { TeamUpdateManyWithoutStartersNestedInputObjectSchema } from '../internals';

export const PlayerUpdateWithoutInjuryInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  scholarship: ScholarshipUpdateManyWithoutPlayerNestedInputObjectSchema,  recruitment: RecruitmentUpdateManyWithoutPlayerNestedInputObjectSchema,  GameEvent: GameEventUpdateManyWithoutPlayerNestedInputObjectSchema,  Squad: SquadUpdateManyWithoutPlayersNestedInputObjectSchema,  Team: TeamUpdateManyWithoutStartersNestedInputObjectSchema
});
