...
export const PlayerCreateWithoutRecruitmentInputObjectSchema = Yup.object({
    id: Yup.string(),  name: Yup.string().required(),  dob: Yup.date().required(),  isDomestic: Yup.boolean(),  photo: Yup.mixed().oneOfSchemas([Yup.string()]),  gender: Yup.string().required(),  healthRecord: HeathRecordCreateNestedOneWithoutPlayerInputObjectSchema,  phone: Yup.string().required(),  streetAddress: Yup.string().required(),  city: Yup.string().required(),  province: Yup.string(),  country: Yup.string(),  postalCode: Yup.string().required(),  scholarship: ScholarshipCreateNestedManyWithoutPlayerInputObjectSchema,  GameEvent: GameEventCreateNestedManyWithoutPlayerInputObjectSchema,  Injury: InjuryCreateNestedManyWithoutPlayerInputObjectSchema,  Squad: SquadCreateNestedManyWithoutPlayersInputObjectSchema,  Team: TeamCreateNestedManyWithoutStartersInputObjectSchema
});
