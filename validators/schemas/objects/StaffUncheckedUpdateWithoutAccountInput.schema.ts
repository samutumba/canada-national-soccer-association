...
export const StaffUncheckedUpdateWithoutAccountInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Squad: SquadUncheckedUpdateManyWithoutStaffNestedInputObjectSchema
});
