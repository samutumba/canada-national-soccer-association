...
export const LocationUpdateWithoutSquadInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  game: GameUpdateManyWithoutLocationNestedInputObjectSchema
});
