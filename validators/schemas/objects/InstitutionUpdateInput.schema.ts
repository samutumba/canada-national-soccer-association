...
import { ScholarshipUpdateManyWithoutSponsorNestedInputObjectSchema } from '../internals';;
import { SquadUpdateManyWithoutInstitutionNestedInputObjectSchema } from '../internals';

export const InstitutionUpdateInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  category: Yup.mixed().oneOfSchemas([EnumInstitutionCategoryFieldUpdateOperationsInputObjectSchema]),  scholarship: ScholarshipUpdateManyWithoutSponsorNestedInputObjectSchema,  Squad: SquadUpdateManyWithoutInstitutionNestedInputObjectSchema
});
