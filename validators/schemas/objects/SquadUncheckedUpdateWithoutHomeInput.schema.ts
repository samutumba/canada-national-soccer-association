...
export const SquadUncheckedUpdateWithoutHomeInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  Team: TeamUncheckedUpdateManyWithoutSquadNestedInputObjectSchema
});
